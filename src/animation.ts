...
export function bakeAnimation(transform: { pos?: RawKeyframesVec3, rot?: RawKeyframesVec3, scale?: RawKeyframesVec3 },
    ...
    dataAnim.position = copy(transform.pos);
    dataAnim.rotation = copy(transform.rot);
    dataAnim.scale = copy(transform.scale);
    ...
    const posDomain = getDomain(transform.pos as KeyframesAny);
    const rotDomain = getDomain(transform.rot as KeyframesAny);
    const scaleDomain = getDomain(transform.scale as KeyframesAny);
