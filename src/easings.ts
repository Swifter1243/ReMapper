...
export function easeOutCubic(
  ...
  return amountOfChange * ((elapsed / duration - 1) * elapsed * elapsed + 1) +
    initialValue;
}
...
export function easeOutQuart(
  ...
  return -amountOfChange *
      ((elapsed / duration - 1) * elapsed * elapsed * elapsed - 1) +
    initialValue;
}
...
export function easeOutQuint(
  ...
  return amountOfChange *
      ((elapsed / duration - 1) * elapsed * elapsed * elapsed * elapsed + 1) +
    initialValue;
}
...
export function easeInCirc(
  ...
  return -amountOfChange * (Math.sqrt(1 - (elapsed / duration) * elapsed) - 1) +
    initialValue;
}
...
export function easeOutCirc(
  ...
  return amountOfChange * Math.sqrt(1 - (elapsed / duration - 1) * elapsed) +
    initialValue;
}
...
export function easeOutBack(
  ...
  return amountOfChange *
      ((elapsed / duration - 1) * elapsed * ((s + 1) * elapsed + s) + 1) +
    initialValue;
}
...
export function easeOutBounce(
  ...
  if ((elapsed /= duration) < 1 / 2.75) {
    ...
    return amountOfChange *
        (7.5625 * (elapsed - 2.625 / 2.75) * elapsed + 0.984375) + initialValue;
  }
}
