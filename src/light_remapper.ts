...
export class LightRemapper extends BaseLightRemapper {
    /**
     ...
     * @returns 
     */
    setLightID(lightID: number | number[]) { return new LightOverrider(this.startType, this.endType, this.range, lightID, this.mulColor); }
