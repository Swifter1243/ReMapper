import { RawKeyframesVec4, RuntimePointDefinitionLinear, RuntimePointDefinitionVec4 } from './animation.ts'
import { RuntimeRawKeyframesVec4 } from './animation.ts'
import { RuntimeRawKeyframesAbstract } from './animation.ts'
import { RuntimeRawKeyframesLinear } from './animation.ts'
import { RawKeyframesLinear } from './animation.ts'
