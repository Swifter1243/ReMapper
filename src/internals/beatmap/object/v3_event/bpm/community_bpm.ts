...
> {
    ...
    static defaults: JsonObjectDefaults<CommunityBPMEvent> = {
        bpm: 120,
    ...
    fromJsonV3(json: bsmap.v3.IBPMChange): this {
    ...
    fromJsonV2(json: bsmap.v2.IBPMChange | bsmap.v2.IBPMChangeOld): this {
