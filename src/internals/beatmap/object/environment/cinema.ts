...
export class CinemaScreen {
    ...
    constructor(
        ...
        if (cinemaLookupMethod == 'URL' && cinemaLookupMethod !== undefined) {
            this.videoUrl = videoID
        }
        if (
            cinemaLookupMethod == 'YoutubeID' &&
            cinemaLookupMethod !== undefined
        ) {
    ...
    push() {
        ...
        if (this.curvature > 180 || this.curvature < 0) {
            cinemaRange('curvature', this.curvature)
        }
        if (this.subsurfaces > 256 || this.subsurfaces < 1) {
            cinemaRange('subsurfaces', this.subsurfaces)
        }
        if (
            this.colorCorrection.brightness < 0 ||
            this.colorCorrection.brightness > 2
        ) {
            cinemaRange(
                'colorCorrection.brightness',
                this.colorCorrection.brightness,
            )
        }
        if (
            this.colorCorrection.contrast > 5 ||
            this.colorCorrection.contrast < 0
        ) cinemaRange('colorCorrection.contrast', this.colorCorrection.contrast)
        if (
            this.colorCorrection.saturation > 5 ||
            this.colorCorrection.saturation < 0
        ) {
            cinemaRange(
                'colorCorrection..saturation',
                this.colorCorrection.saturation,
            )
        }
        if (
            this.colorCorrection.exposure > 5 ||
            this.colorCorrection.exposure < 0
        ) cinemaRange('colorCorrection.exposure', this.colorCorrection.exposure)
        if (this.colorCorrection.gamma > 5 || this.colorCorrection.gamma < 0) {
            cinemaRange('colorCorrection.gamma', this.colorCorrection.gamma)
        }
        if (this.colorCorrection.hue > 360 || this.colorCorrection.hue < -360) {
            cinemaRange('colorCorrection.hue', this.colorCorrection.hue)
        }
    ...
    get configByMapper() {
        return this.json.configByMapper
    }
...
This setting prevents the user from overriding the environment. */
    ...
    get curvature() {
        return this.json.screenCurvature
    }
    ...
    get subsurfaces() {
        return this.json.screenSubsurfaces
    }
    ...
    get allowCustomPlatform() {
        return this.json.allowCustomPlatform
    }
    ...
    get disableDefaultModifications() {
        return this.json.disableDefaultModifications
    }
    /** Set this to true to have your environment modifications applied even if no video is defined or downloaded by the user. */
    get forceEnvironmentModifications() {
        return this.json.forceEnvironmentModifications
    }
    /** If this is set to true, all cloned lights will be merged with existing prop groups, based on the specified z-position. Note: This will make lighting_v3 using light IDs nearly impossible, if you plan on using that. Also, if your cloned light is placed at a z-position where no pre-existing lights are, a new prop group will be created, which will change the IDs of other prop groups and potentially mess up your lightshow. */
    get mergePropGroups() {
        return this.json.mergePropGroups
    }
    ...
    get colorCorrection() {
        return objectSafeGet<ColorCorrection>(this.json, 'colorCorrection', {
            brightness: 0,
            contrast: 0,
            exposure: 0,
            gamma: 0,
    ...
    get vignette() {
        return objectSafeGet<Vignette>(this.json, 'vignette', {
            radius: 0,
            softness: 0,
            type: 'elliptical',
        })!
    ...
    set videoID(value: string) {
        this.json.videoID = value
    }
    set videoUrl(value: string) {
        this.json.videoUrl = value
    }
    ...
    set videoFile(value: string) {
        this.json.videoFile = value + '.mp4'
    }
    set duration(value: number) {
        this.json.duration = value
    }
    set offset(value: number) {
        this.json.offset = value
    }
    set configByMapper(value: boolean) {
        this.json.configByMapper = value
    }

    set environmentName(value: string) {
        this.json.environmentName = value
    }
    set playbackSpeed(value: number) {
        this.json.playbackSpeed = value
    }
    set loop(value: boolean) {
        this.json.loop = value
    }
    set endVideoAt(value: number) {
    ...
    set curvature(value: number) {
        this.json.screenCurvature = value
    }
    set subsurfaces(value: number) {
        this.json.screenSubsurfaces = value
    }
    set allowCustomPlatform(value: boolean) {
        this.json.allowCustomPlatform = value
    }
    set disableDefaultModifications(value: boolean) {
        this.json.disableDefaultModifications = value
    }
    set forceEnvironmentModifications(value: boolean) {
        this.json.forceEnvironmentModifications = value
    }
    set mergePropGroups(value: boolean) {
        this.json.mergePropGroups = value
    }
    set transparency(value: boolean) {
        this.json.transparency = value
    }
    set bloom(value: number) {
        this.json.bloom = value
    }

    set colorCorrection(value: ColorCorrection) {
        this.json.colorCorrection = value
    }
    set vignette(value: Vignette) {
        this.json.vignette = value
    }
}
