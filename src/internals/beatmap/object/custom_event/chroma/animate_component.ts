...
export class AnimateComponent extends CustomEvent<never, bsmap.v3.ICustomEventAnimateComponent> {
    constructor(
        ...
        this.lightMultiplier = params.lightMultiplier ?? AnimateComponent.defaults.lightMultiplier
        this.fog = params.fog ?? AnimateComponent.defaults.fog
    }
    ...
    static defaults: Fields<AnimateComponent> = {
        duration: undefined,
        easing: undefined,
        lightMultiplier: {},
        fog: {},
    ...
    fromJsonV3(json: bsmap.v3.ICustomEventAnimateComponent): this {
        ...
        this.easing = getDataProp(json.d, 'easing') as EASE ?? AnimateComponent.defaults.easing
        this.lightMultiplier =
            getDataProp(json.d, 'TubeBloomPrePassLight') as typeof this.lightMultiplier ??
                AnimateComponent.defaults.lightMultiplier
        this.fog = getDataProp(json.d, 'BloomFogEnvironment') as typeof this.fog ??
            AnimateComponent.defaults.lightMultiplier
    ...
    toJsonV3(prune?: boolean): bsmap.v3.ICustomEventAnimateComponent {
        ...
        const output = {
            ...
            d: {
                ...
                easing: this.easing,
                TubeBloomPrePassLight: this
                    .lightMultiplier as bsmap.v3.ICustomEventAnimateComponent['d'][
                        'TubeBloomPrePassLight'
                    ],
                BloomFogEnvironment: this
                    .fog as bsmap.v3.ICustomEventAnimateComponent['d']['BloomFogEnvironment'],
                ...this.data,
            },
