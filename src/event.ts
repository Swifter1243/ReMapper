...
export class RotationEvent extends BaseObject {
  ...
  get early() {
    return this.json.e === 0;
  }

  set rotation(value: number) {
    this.json.r = value;
  }
  set early(value: boolean) {
    this.json.e = value ? 0 : 1;
  }
}
...
export class LightEventBox extends EventBox {
  ...
  set boxGroups(value: LightEventBoxGroup[]) {
    this.json.g = value;
  }
}
...
export class LightRotationBox extends EventBox {
  ...
  set boxGroups(value: LightRotationBoxGroup[]) {
    this.json.g = value;
  }
}
...
export class EventBoxGroup {
  ...
  set filter(value: EventFilter) {
    this.json.f = value;
  }
  set filterType(value: FILTERTYPE) {
    this.json.f.f = value;
  }
  set filterParam0(value: number) {
    this.json.f.p = value;
  }
  set filterParam1(value: number) {
    this.json.f.t = value;
  }
  set filterReverse(value: boolean) {
    this.json.f.r = value ? 1 : 0;
  }
  set beatDistribution(value: number) {
    this.json.w = value;
  }
  set beatDistributionType(value: DISTTYPE) {
    this.json.d = value;
  }
...
export class LightEventBoxGroup extends EventBoxGroup {
  ...
  get brightnessDistributionFirst() {
    return this.json.b === 1;
  }
  ...
  set brightnessDistribution(value: number) {
    this.json.r = value;
  }
  set brightnessDistributionType(value: DISTTYPE) {
    this.json.t = value;
  }
  set brightnessDistributionFirst(value: boolean) {
    this.json.b = value ? 1 : 0;
  }
  set events(value: LightEvent[]) {
    this.json.e = value;
  }
}
...
export class LightRotationBoxGroup extends EventBoxGroup {
  ...
  set rotationDistribution(value: number) {
    this.json.s = value;
  }
  set rotationDistributionType(value: DISTTYPE) {
    this.json.t = value;
  }
  set rotationDistributionFirst(value: boolean) {
    this.json.b = value ? 1 : 0;
  }
  set axis(value: AXIS) {
    this.json.a = value;
  ...
  set flipped(value: boolean) {
    this.json.r = value ? 1 : 0;
  }
  set events(value: LightRotation[]) {
    this.json.l = value;
  }
}
...
export class LightEvent {
  ...
  set addedBeat(value: number) {
    this.json.b = value;
  }
  set transition(value: LIGHTTRANS) {
    this.json.i = value;
  }
  set color(value: LIGHTCOL) {
    this.json.c = value;
  }
  set brightness(value: number) {
    this.json.s = value;
  }
  set flickerFrequency(value: number) {
    this.json.f = value;
  }
}
...
export class LightRotation {
  ...
  set transition(value: ROTTRANS) {
    this.json.p = value;
  }
  set ease(value: ROTEASE) {
    this.json.e = value;
  }
