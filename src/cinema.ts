...
export class CinemaScreen {
  ...
  constructor(
    ...
    if (cinemaLookupMethod == "YoutubeID" && cinemaLookupMethod !== undefined) {
  ...
  push() {
    ...
    if (
      this.colorCorrection.brightness < 0 || this.colorCorrection.brightness > 2
    ) {
      cinemaRange(
    ...
    if (
      this.colorCorrection.contrast > 5 || this.colorCorrection.contrast < 0
    ) cinemaRange("colorCorrection.contrast", this.colorCorrection.contrast);
    if (
      this.colorCorrection.saturation > 5 || this.colorCorrection.saturation < 0
    ) {
      cinemaRange(
    ...
    if (
      this.colorCorrection.exposure > 5 || this.colorCorrection.exposure < 0
